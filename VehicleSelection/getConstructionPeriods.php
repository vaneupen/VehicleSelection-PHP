		...
		<h1>getConstructionPeriods</h1>
			...
			<?php
				...
				try {
					...
					$tag['getConstructionPeriods'] = $request;
					...
					$objConversions = $wsdlDatei_eval2 -> __soapCall('getConstructionPeriods', $getCardata);
