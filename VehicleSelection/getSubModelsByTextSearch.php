...
<body>
	...
	<section>
		<article>
		<h1>getSubModelsByTextSearch</h1>
			<p>
			<?php
				...
				try {
					...
					$tag['getSubModelsByTextSearch'] = $request;
					...
					$objConversions = $wsdlDatei_eval2 -> __soapCall('getSubModelsByTextSearch', $getCardata);
