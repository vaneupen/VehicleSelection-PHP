		...
		<h1>date2ConstructionTime</h1>
			...
			<?php
				...
				try {
					...
					$date='2011-08-01T00:00:00.000+02:00';

					$request = new SoapVar('<request>
								<date>'.$date.'</date>
								</request>',XSD_ANYXML);

					$tag['date2ConstructionTime'] = $request;
					...
					$objConversions = $wsdlDatei_eval2 -> __soapCall('date2ConstructionTime', $getCardata); 
