			...
			<?php
				...
				try {
					...
					$request = new SoapVar('<request>
								<constructionTime>'.$bauzeit.'</constructionTime>
								</request>',XSD_ANYXML);

					$tag['constructionTime2Date'] = $request;
					...
					$objConversions = $wsdlDatei_eval2 -> __soapCall('constructionTime2Date', $getCardata);
