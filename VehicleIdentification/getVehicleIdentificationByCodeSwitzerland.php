			...
			<?php
				...
				try {
					...
					$request = new SoapVar('<request>
								...
								<typeNoteNumber>'.$typeNoteNumber.'</typeNoteNumber>
								</request>',XSD_ANYXML);

					$tag['getVehicleIdentificationByCodeSwitzerland'] = $request;
					...
					$objConversions = $wsdlDatei_eval2 -> __soapCall('getVehicleIdentificationByCodeSwitzerland', $getCardata);
