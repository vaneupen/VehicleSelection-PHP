...
<body>
	...
	<section>
		<article>
		<h1>getVehicleIdentificationByNationalCodeAustria</h1>
			<p>
			<?php
				...
				try {
					...
					$parameter->request->locale->datCountryIndicator = "AT";
					...
					$parameter->request->nationalCode = $nationalCode;

					// SOAP call
					$response = $client->getVehicleIdentificationByNationalCodeAustria($parameter);
