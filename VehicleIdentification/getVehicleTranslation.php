			...
			<?php
				...
				try {
					...
					$request = new SoapVar('<request>
								...
								<specialEquipmentId>'.$equipId1.'</specialEquipmentId>
								<specialEquipmentId>'.$equipId2.'</specialEquipmentId>
								<specialEquipmentId>'.$equipId3.'</specialEquipmentId>
								<specialEquipmentId>'.$equipId4.'</specialEquipmentId>
								<language>'.$AdditionalLanguage.'</language>
								</request>',XSD_ANYXML);

					$tag['getVehicleTranslation'] = $request;
					...
					$objConversions = $wsdlDatei_eval2 -> __soapCall('getVehicleTranslation', $getCardata);
